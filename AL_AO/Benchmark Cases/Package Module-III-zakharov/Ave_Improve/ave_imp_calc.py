...
def calculate_improvement(file_path_save, benchmark, method, iter):
    ...
    for i in range(1, iter + 1):
        ...
        # select the maximum value in the current iteration
        ...
        if df_imp < 0:
            df_imp = 0  # If improvement is less than 0, set to 0
...
if __name__ == "__main__":
    ...
    # file_path_save = f"Multi-Objective Optimisation\Benchmark\Package Module-III-zakharov\Ave_Improve\\{method}_improvement_analysis_a-{alpha}-{dim}D.xlsx"
    # file_path_save = f"Multi-Objective Optimisation\Benchmark\Package Module-III-zakharov\Ave_Improve\\{method}_improvement_analysis.xlsx"

    # calc BO_3D results

    method = f"BO_POI_{dim}D"  # Specify the method for which you want to calculate the improvement
    file_path_save = f"Multi-Objective Optimisation\Benchmark\Package Module-III-zakharov\Ave_Improve\\{method}_improvement_analysis.xlsx"   # calc BO_3D results
