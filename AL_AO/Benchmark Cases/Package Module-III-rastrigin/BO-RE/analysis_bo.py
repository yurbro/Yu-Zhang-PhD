...
if __name__ == "__main__":
    ...
    path = 'Multi-Objective Optimisation\\Benchmark\\Package Module-III-rastrigin\\BO-RE'
    # Test PROPOSED-xD
    dim = 3  # DDimension of the problem
    filename = 'single_bo_results_Rastrigin.xlsx'  # Change to your file name
    ...
    set_plot_style(dim, alpha_columns_5d, iterations_5d, path, df_5d, alpha_cols_5d, special_cols_5d, benchmark='Rastrigin')
