...
if __name__ == "__main__":
    ...
    lb = np.array([-60] * d)  # Lower bounds
    ub = np.array([60] * d)   # Upper bounds
    ...
    directory = "Multi-Objective Optimisation\\Benchmark\\Package Module-III-sphere\\Dataset"  # Directory to save the initial experiment data
    directory_af = "Multi-Objective Optimisation\\Benchmark\\Package Module-III-sphere\\Results" # Directory to save the acquisition function results
