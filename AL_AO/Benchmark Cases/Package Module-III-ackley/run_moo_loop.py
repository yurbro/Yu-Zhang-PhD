...
if __name__ == "__main__":
    ...
    lb = np.array([-32.768] * d)  # Lower bounds
    ub = np.array([32.768] * d)   # Upper bounds
    method = f'RANDOM-{d}D'  # Method name for the optimisation; can be 'EI', 'HV', 'RANDOM', or 'PROPOSED'
    benchmark = 'Ackley'  # Benchmark function to be used, which is Ackley in this case; more benchmarks can be added later
    directory = "Multi-Objective Optimisation\\Benchmark\\Package Module-III-ackley\\Dataset"  # Directory to save the initial experiment data
    directory_af = "Multi-Objective Optimisation\\Benchmark\\Package Module-III-ackley\\Results" # Directory to save the acquisition function results
