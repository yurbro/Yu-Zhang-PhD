...
def calculate_improvement(file_path_save, benchmark, method, iter):
    ...
    for i in range(1, iter + 1):
        ...
        # Get the maximum value in the current iteration
...
if __name__ == "__main__":
    ...
    file_path_save = f"Multi-Objective Optimisation\Benchmark\Package Module-III-rastrigin\Ave_Improve\\{method}_improvement_analysis.xlsx"   # calc BO_3D results
