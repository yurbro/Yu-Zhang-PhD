...
if __name__ == '__main__':
    ...
    filename = f"lhs_samples_ackley_{method}-{dim}D.xlsx"
    path = 'Multi-Objective Optimisation\Benchmark\Package Module-IIII\Dataset'
    save_path = f'Multi-Objective Optimisation\Benchmark\Package Module-IIII\Loocv_RE\{method}'
