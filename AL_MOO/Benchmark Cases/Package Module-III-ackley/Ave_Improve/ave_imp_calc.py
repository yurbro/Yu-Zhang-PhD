...
if __name__ == "__main__":
    ...
    # file_path_save = f"Multi-Objective Optimisation\Benchmark\Package Module-III-ackley\Ave_Improve\\{method}_improvement_analysis.xlsx"

    # calc BO_3D results

    method = f"BO_POI_{dim}D"  # Specify the method for which you want to calculate the improvement
    file_path_save = f"Multi-Objective Optimisation\Benchmark\Package Module-III-ackley\Ave_Improve\\{method}_improvement_analysis.xlsx"   # calc BO_3D results
