...
# ax.set_yscale('log')       # Optional: Uncomment to use log scale if the gap is too large

# ========= 6. LEGEND =========
ax.legend(fontsize=11, loc='best')

# ========= 7. SHOW/SAVE =========
plt.tick_params(axis='both', labelsize=12)  # Set x and y axis label size to 12
plt.tight_layout()
