...
if __name__ == '__main__':
    # Load data
    dim = 5  # Specify the dimension, 3/5
    method = 'PROPOSED'  # Specify the method used, E.G., 'PROPOSED', 'EI', 'HV', 'RANDOM'
    ...
    save_path = f'Multi-Objective Optimisation\Benchmark\Package Module-III-sphere\Loocv_RE\{method}-{dim}D'
    ...
    for iter in range(0, iter):
        ...
        optimizer.maximize(init_points=2, n_iter=20, acquisition_function=UtilityFunction(kind='ei', xi=0.1))
