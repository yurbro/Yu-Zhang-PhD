...
if __name__ == "__main__":
    ...
    lb = np.array([-10] * d)  # Lower bounds
    ub = np.array([10] * d)   # Upper bounds
    ...
    directory = "Multi-Objective Optimisation\\Benchmark\\Package Module-III-zakharov\\Dataset"  # Directory to save the initial experiment data
    directory_af = "Multi-Objective Optimisation\\Benchmark\\Package Module-III-zakharov\\Results" # Directory to save the acquisition function results
