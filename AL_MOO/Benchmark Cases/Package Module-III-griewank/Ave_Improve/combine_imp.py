...
def create_analysis_excel(file_path_save, method, alpha, dim):
...
if __name__ == "__main__":
    ...
    print(f"Analysis Excel file created at: Multi-Objective Optimisation\\Benchmark\\Package Module-IIII\\Ave_Improve\\{method}_improvement_analysis_a-{alpha}-{dim}D.xlsx")
