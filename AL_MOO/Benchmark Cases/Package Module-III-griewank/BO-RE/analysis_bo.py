...
if __name__ == "__main__":
    ...
    # 读取数据文件
    path = 'Multi-Objective Optimisation\\Benchmark\\Package Module-III-griewank\\BO-RE'
    # Test PROPOSED-xD
    dim = 3  # 维度
    filename = 'single_bo_results_Griewank.xlsx'  # 修改为你的文件名
    ...
    # 调用函数绘图
    set_plot_style(dim, alpha_columns_5d, iterations_5d, path, df_5d, alpha_cols_5d, special_cols_5d, benchmark='Griewank')
