"""
    This script is trying to implement the constraint-guided ABIC acquisition strategy for filtering the results of Plain SR.
"""
...
# -----------------------------
CSV_PATH = r"Symbolic Regression/srloop/other models/Plain SR/data/hall_of_fame_run-plainSR_maxsize38_restored.csv"  # 你的最终轮CSV TODO: 修改为你的CSV路径
EXPR_COL = "restored_equation"          # 如无可改为 'equation' 或 'sympy_format'
SAVE_DIR = r"Symbolic Regression/srloop/other models/Plain SR/data"
