...
if __name__ == "__main__":
    ...
    num = 6
    fame_csv = f'Symbolic Regression/srloop/other models/Plain SR/data/hall_of_fame_plainSR_maxsize38.csv'
    mapping_csv = f'Symbolic Regression/srloop/other models/Plain SR/data/variable_index_mapping_run-plainSR_maxsize38.csv'
    output_csv = f'Symbolic Regression/srloop/other models/Plain SR/data/hall_of_fame_run-plainSR_maxsize38_restored.csv'
    ...
    # 对这些表达式求导并筛选dQ/dt>0
    save_filtered = f'Symbolic Regression/srloop/other models/Plain SR/data/hall_of_fame_run-plainSR_maxsize38_positive_deriv.csv'
