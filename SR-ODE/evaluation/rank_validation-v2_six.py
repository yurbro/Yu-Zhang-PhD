...
# ====== USER CONFIG (直接改这里即可) ======
DEFAULT_TEST_PATH = r"Symbolic Differential/SymODE/evaluation/pred_test-six.csv"
DEFAULT_OUT_DIR   = r"Symbolic Differential/SymODE/evaluation/rank_report-six"
MC_REPS = 20
SEED    = 20251009
K_FOR_SUMMARY = 2   # summary里Hit@k/P@k用的k
GAINS_Q_LIST = [0.20, 0.25, 0.30]   # ⭐ 多条Top-q%：20%、25%、30%
